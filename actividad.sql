...
INSERT INTO Boleta (cliente_id, nroBoleta, fecha, total) VALUES (1, 1856, '2023-03-01', 5500.0);
INSERT INTO Boleta (cliente_id, nroBoleta, fecha, total) VALUES (2, 1578, '2023-02-28', 6400.0);

SELECT * FROM Boleta;

#Tabla relacionada Boleta/Cliente
CREATE TABLE BoletaCliente(
	boletaCliente_id INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
    boleta_id INTEGER NOT NULL,
    cliente_id INTEGER NOT NULL
);

INSERT INTO BoletaCliente (cliente_id, boleta_id) VALUES (1,2);
INSERT INTO BoletaCliente (cliente_id, boleta_id) VALUES (2,1);

SELECT * FROM BoletaCliente;
